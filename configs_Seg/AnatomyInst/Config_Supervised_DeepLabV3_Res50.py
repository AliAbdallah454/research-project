...
datasets = [
#['Wetlab_Instruments_train_FINAL.csv', 'Wetlab_Instruments_train_FINAL.csv', 'Wetlab_Instruments_test_FINAL.csv', 1],
['Wetlab_Instruments_train_fold0.csv', 'Wetlab_Instruments_train_fold0.csv', 'Wetlab_Instruments_test_fold0.csv', 1],
#['Wetlab_Instruments_train_fold2.csv', 'Wetlab_Instruments_train_fold2.csv', 'Wetlab_Instruments_test_fold2.csv', 1],
#['Wetlab_Instruments_train_fold3.csv', 'Wetlab_Instruments_train_fold3.csv', 'Wetlab_Instruments_test_fold3.csv', 1]
]
...
Results_path = '/mnt/data/wetcat_dataset/wetcat_code/Results/'
Visualization_path = 'visualization_Wetlab/'
CSV_path = 'CSVs_Wetlab/'
Checkpoint_path = 'checkpoints_Wetlab/'
TrainIDs_path = '/mnt/data/wetcat_dataset/wetcat_code/TrainIDs_Seg_Instruments/'
