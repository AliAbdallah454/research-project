...
# -*- coding: utf-8 -*-
"""
Created on Thu Feb 19 20:58:58 2026
...
from utils.dataset_seg import BasicDataset as BasicDataset_CSV
from utils.dataset_seg import BasicDataset as BasicDataset_CSV_test
...
def train_net(net,
    ...
    # Change batch_size=1 to batch_size=batch_size
    ...
    try:
        for LR in range(len(Learning_Rates_init)):
            ...
            for c in range(len(datasets)):      
                ...
                # net = Net1
                # We add () to create the object, and pass num_classes
                # print(f'Allowed arguments for Net1:', {inspect.signature(Net1.__init__)})
                net = Net1(backbone='resnet50',nclass=num_classes)
                # logging.info(f'Network:\n'
                #              f'\t{net.n_classes} output channels (classes)\n')
                logging.info(f'Network:\n'
                             f'\t{net.__class__} output channels (classes)\n')
